using HomeworkLinqAndLambdas.Models;
using System;
...
namespace HomeworkLinqAndLambdas
{
    public class SampleData
    {
        ...
        public static List<PersonModel> GetContactData()
        {
            ...
            {
                new PersonModel{Id=1,FirstName="Darshit",LastName="Shah",Addresses = new List<int> {1,2,3,}},
                new PersonModel{Id=1,FirstName="Bilbo",LastName="Beggins",Addresses = new List<int> {1}},
                new PersonModel{Id=1,FirstName="Will",LastName="Biers",Addresses = new List<int> {2}},
                new PersonModel{Id=1,FirstName="Nick",LastName="Fury",Addresses = new List<int> {3}},
                new PersonModel{Id=1,FirstName="John",LastName="Cena",Addresses = new List<int> {2,3,}}
            };
            return output;
        }
